...
class RegistrationFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.email_input = Input(page, 'registration-form-email-input', name="registration form email input")
        self.username_input = Input(page, 'registration-form-username-input',
                                    name="registration form username input")
        self.password_input = Input(page, 'registration-form-password-input',
                                    name="registration form password input")
